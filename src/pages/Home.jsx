...
import { ArrowUpRightIcon, GithubIcon, LinkedinIcon, TechnologyIcon } from "../components/Icons";
  ...
  return (
    <main className="overflow-hidden">
      ...
      <section className="relative mx-auto grid min-h-[calc(100vh-90px)] max-w-6xl items-center gap-14 px-6 py-20 lg:grid-cols-[1.15fr_.85fr] lg:py-24">
        ...
        {/* Introduction */}
        <p className="font-mono text-xs uppercase tracking-[0.25em] text-blue-500">Anas Shiraz / Frontend developer</p>

        {/* Name */}
        <h1 className="mt-3 max-w-3xl text-5xl font-bold tracking-[-0.04em] text-neutral-900 md:text-7xl dark:text-neutral-100">
          Building digital <span className="text-blue-500">experiences</span> that feel effortless.
        </h1>
        ...
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-neutral-600 dark:text-neutral-300 md:text-lg">
          ...
          Currently focused on React and expanding my skills toward backend
        ...
        <div className="relative mx-auto w-full max-w-md animate-scale-in animation-delay-200 lg:ml-auto">
          ...
          <div className="relative overflow-hidden rounded-4xl border border-neutral-200 bg-neutral-50 p-5 shadow-2xl shadow-neutral-200/60 dark:border-neutral-800 dark:bg-neutral-900 dark:shadow-black/20">
            <div className="flex items-center justify-between border-b border-neutral-200 pb-4 dark:border-neutral-800">
              ...
              <span className="font-mono text-[10px] uppercase tracking-[0.2em] text-neutral-400">anas.dev</span>
            </div>
            <div className="space-y-5 px-2 py-8 font-mono text-sm">
              <p className="text-neutral-400"><span className="text-violet-500">const</span> developer = <span className="text-blue-500">{"{"}</span></p>
              <p className="pl-5 text-neutral-500">name: <span className="text-emerald-500">"Anas Shiraz"</span>,</p>
              <p className="pl-5 text-neutral-500">focus: <span className="text-emerald-500">"Frontend"</span>,</p>
              <p className="pl-5 text-neutral-500">stack: <span className="text-emerald-500">"React + Tailwind"</span>,</p>
              <p className="pl-5 text-neutral-500">status: <span className="text-emerald-500">"open_to_work"</span></p>
            ...
            <div className="flex items-center justify-between rounded-xl bg-white px-4 py-3 text-xs text-neutral-500 dark:bg-neutral-950 dark:text-neutral-400">
              <span>Currently building</span><span className="font-medium text-neutral-900 dark:text-neutral-100">the next idea ✦</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-6xl animate-fade-up animation-delay-300 grid-cols-2 border-y border-neutral-200 px-6 py-8 dark:border-neutral-800 sm:grid-cols-4">
        {[["02+", "Projects shipped"], ["04", "Core technologies"], ["100%", "Curiosity"], ["∞", "Ideas to build"]].map(([value, label]) => (
          <div key={label} className="border-neutral-200 px-4 first:pl-0 dark:border-neutral-800 sm:border-l sm:pl-6">
